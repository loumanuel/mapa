             ...
             <div>
                 <div className="row my-2">
                     <div className="col-12">
                         <button className="btn btn-dark" onClick={this.handleLugares}>Lugares Cercanos</button>
                     </div>
                 </div>                
                     ...
                     {this.props.mostrar &&                             
                         this.state.morePlaces &&
                             <div className="card-body">
                                 <button className="btn btn-dark" onClick={this.calcularVerMas}>Ver mas lugares</button>
                             </div>
                     }                      
                     </div>                                         
                 </div>                   
