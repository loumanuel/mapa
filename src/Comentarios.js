 ...
 class Comentarios extends React.Component {
     ...
     render(){
         ...
         if (this.state.isComment) {
             button = <button className="btn btn-dark" onClick={this.handleMostrarComment}>Mostrar Comentarios</button>
         }else {
             button = <button className="btn btn-dark" onClick={this.handleOcultarComment}>Ocultar Comentarios</button>
         }
         return (
             <div>
